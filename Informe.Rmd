...
Dados las siguiente matriz de decisión con seis criterios con pesos: 43% , 26% , 14%, 8.3%, 4.8%, 3.18% respectivamente: 
...
Es la misma ordenación independeientemente de si es con medias o sin ellas. 
Obteniendo de nuevo que la mejora más óptima es que se implemente una telemetría completa en el coche al igual que se concluía haciendo uso del método ELECTRE. 
...
Podemos determinar que en rasgos generales las alternativas más óptimas para su implementación en el equipo aon buscar una nueva configuración para optimizar el rendimiento de la batería y el desarrollo de un sistema d emonotorización a tiempo real o telemetría como hemos estado llamándolo duarante todo el proyecto. 
